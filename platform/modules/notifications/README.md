...
Per the current instructions, the **notifications** module is intentionally **not**
implemented yet. It exists as an empty module boundary so that a future
instruction (e.g. "Now build the notifications module") can be implemented here
...
- Routes under `app/api/notifications/...`
- Admin UI under `app/admin/notifications/...` (nav entry already scaffolded)
