# discussions module (not yet implemented)

This folder is a placeholder reserved by the Foundation Phase architecture.

Per the current instructions, the **discussions** module is intentionally **not**
implemented yet. It exists as an empty module boundary so that a future
instruction (e.g. "Now build the discussions module") can be implemented here
...
- Routes under `app/api/discussions/...`
- Admin UI under `app/admin/discussions/...` (nav entry already scaffolded)
- Tests under `tests/discussions/`
